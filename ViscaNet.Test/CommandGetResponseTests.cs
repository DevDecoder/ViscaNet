...
namespace ViscaNet.Test
{
    public sealed class CommandGetResponseTests : TestsBase
    {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Ack_response_with_offset(Command command)
        {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Ack_response_with_count(Command command)
        {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Ack_response_with_offset_and_count(Command command)
        {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Offset_too_big_error(Command command)
        {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Offset_EOL_error(Command command)
        {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Count_empty_error(Command command)
        {
        ...
        [Theory]
        [ClassData(typeof(NoResponsesTestData))]
        public void Count_too_big_error(Command command)
        {
